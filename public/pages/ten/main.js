...
fetch("../../data.json")
  ...
  .then((data) => {
    ...
    <a class='expand' href='../../${data[9].images.hero.small}'  data-lightbox="mygallery" target='_top'><div class='view'><img src="https://img.icons8.com/ios-glyphs/24/ffffff/expand--v1.png"/><p>VIEW IMAGE</p></div></a>
